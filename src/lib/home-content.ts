...
export const services: HomeLinkItem[] = [
  ...
  { title: "Independent Inspection Services", text: "Impartial third-party inspection, witness testing and code conformance.", to: "/our-services/inspection-project-services", icon: ScanLine, image: svcIpsIndependentInspection, imageAlt: "Independent inspection of industrial equipment" },
  { title: "Expediting & Vendor Assessment", text: "Supply-chain expediting, manufacturer audits and quality system evaluation.", to: "/our-services/inspection-project-services", icon: ClipboardCheck, image: svcIpsExpediting, imageAlt: "Equipment expediting and vendor assessment activity" },
  { title: "Project QA-QC & Asset Verification", text: "Quality management, specification compliance and plant asset verification.", to: "/our-services/inspection-project-services", icon: ClipboardCheck, image: svcIpsProjectQaQc, imageAlt: "Project quality assurance and inspection documentation" },

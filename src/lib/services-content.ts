...
export const serviceCards: ServiceCard[] = [
  ...
  { title: "Third-Party Inspection Services", description: "Independent technical inspection and verification support for equipment, installations, vendors, assets and maintenance activities, with scope and personnel qualifications confirmed per project.", areas: ["Equipment and vendor inspection", "Electrical inspection", "Welding and coating inspection", "NDT coordination", "Thermography", "Asset condition inspection", "Calibration support", "Predictive maintenance assessment", "Integrity inspection"], to: "/our-services/third-party-inspection", icon: SearchCheck },
...
export const assetIntegrityServices = [
  { title: "Risk-Based Inspection", text: "A structured approach to prioritizing inspection based on probability and consequence of failure, helping focus inspection resources on assets and mechanisms that present greater risk.", to: "/our-services/asset-integrity/risk-based-inspection" },
  { title: "Asset Integrity Assessment", text: "Baseline assessment of asset condition, degradation mechanisms, criticality and integrity risks to support practical lifecycle decisions.", to: "/our-services/asset-integrity/asset-integrity-assessment" },
  { title: "Inspection Planning", text: "Structured inspection planning based on asset condition, history, failure mechanisms, risk, operating requirements and planned maintenance or shutdown windows.", to: "/our-services/asset-integrity/inspection-planning" },

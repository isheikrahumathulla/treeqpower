...
export function HomePage() {
  return <main>
    ...
    <section className="home-technical reveal"><div className="zoho-shell home-technical-grid"><div><p className="zoho-kicker">Featured Technical Solutions</p><h2>Power & Technical Solutions for Critical Systems</h2><p>Navigate directly to the engineered equipment, field service and lifecycle support relevant to your system.</p><div className="home-technical-image"><img src={images.powerlines} alt="Power infrastructure supporting critical electrical systems" loading="lazy" width="900" height="650"/></div></div><div className="home-technical-links">{technicalSolutions.map((item, index) => <SiteLink to={item.to} key={item.title}><span>{String(index + 1).padStart(2, "0")}</span><strong>{item.title}</strong><ArrowRight/></SiteLink>)}</div></div></section>

    <section className="home-feature reveal"><div className="home-feature-image"><img src={homeImages.inspection} alt="Industrial asset integrity inspection and condition assessment" loading="lazy" width="1000" height="800"/></div><div className="home-feature-copy"><p className="zoho-kicker">Asset Integrity</p><h2>Make Better Decisions About Critical Assets</h2><p>Effective asset management starts with understanding condition, risk and performance.</p><p>TreeQ Power’s engineering, inspection and asset integrity capabilities help clients assess equipment condition, identify potential failure mechanisms, prioritize inspection and maintenance activities, and develop practical strategies for managing critical assets throughout their operating lifecycle.</p><Button asChild><SiteLink to="/services/asset-integrity/asset-integrity-management">Explore Asset Integrity Services<ArrowRight/></SiteLink></Button></div></section>

    <section className="home-feature home-feature-reverse reveal"><div className="home-feature-image"><img src={homeImages.solar} alt="Commercial solar and sustainable energy solution" loading="lazy" width="1000" height="800"/></div><div className="home-feature-copy"><p className="zoho-kicker">Sustainability</p><h2>Engineering for Energy Efficiency & Sustainable Performance</h2><p>TreeQ Power supports energy-conscious projects through energy audits, energy management, sustainable design, energy modelling, efficient electrical and lighting solutions, renewable energy systems and performance-focused engineering.</p><Button asChild><SiteLink to="/services/sustainability/green-energy-sustainable-design">Explore Sustainable Solutions<ArrowRight/></SiteLink></Button></div></section>

    <section className="home-projects reveal"><div className="zoho-shell"><SectionHeading eyebrow="Project Experience" title="Our Projects" intro="Verified project information and photography will be added after client approval."/><div className="home-project-grid">{[1,2,3].map(item => <article key={item}><div className="home-project-placeholder"><ImageIcon/><span>Project image to be provided</span></div><div className="home-project-copy"><h3>Project Name</h3><dl><div><dt>Industry</dt><dd>[To be updated]</dd></div><div><dt>Location</dt><dd>[To be updated]</dd></div><div><dt>Scope</dt><dd>[To be updated]</dd></div><div><dt>Services</dt><dd>[To be updated]</dd></div><div><dt>Result</dt><dd>[To be updated]</dd></div></dl><span className="home-disabled-link">View Project</span></div></article>)}</div><Button variant="outline" asChild><SiteLink to="/projects">View Projects<ArrowRight/></SiteLink></Button></div></section>

    <section className="home-resources reveal"><div className="zoho-shell"><SectionHeading eyebrow="Resources" title="Technical Insights & Resources"/><div className="home-resource-grid"><SiteLink to="/resources/blog"><FileText/><h3>Technical Insights</h3><p>For future technical articles and industry insights.</p><ArrowRight/></SiteLink><SiteLink to="/resources/downloads"><Check/><h3>Downloads</h3><p>For company brochures, technical documents and downloadable resources.</p><ArrowRight/></SiteLink><SiteLink to="/resources/faqs"><HelpCircle/><h3>FAQs</h3><p>Answers to common questions about TreeQ Power services and solutions.</p><ArrowRight/></SiteLink></div></div></section>

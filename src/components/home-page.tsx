...
export function HomePage() {
  return <main>
    ...
    <section className="home-catalog home-catalog-alt reveal"><div className="zoho-shell"><SectionHeading eyebrow="Our Solutions" title="Power, Automation, MEP & Building Technology Solutions"/><div className="home-scroll-grid">{solutions.map(item => <ImageCard item={item} key={item.title}/>)}</div><Button variant="outline" asChild><SiteLink to="/our-services/electrical-automation">Explore All Solutions<ArrowRight/></SiteLink></Button></div></section>
    ...
    <section className="home-feature reveal"><div className="home-feature-image"><img src={lib.industrialMachineryPanel} alt="Industrial asset integrity inspection and condition assessment" loading="lazy" width="1000" height="800"/></div><div className="home-feature-copy"><p className="zoho-kicker">Asset Integrity</p><h2>Make Better Decisions About Critical Assets</h2><p>Effective asset management starts with understanding condition, risk and performance.</p><p>TreeQ Power’s engineering, inspection and asset integrity capabilities help clients assess equipment condition, identify potential failure mechanisms, prioritize inspection and maintenance activities, and develop practical strategies for managing critical assets throughout their operating lifecycle.</p><Button asChild><SiteLink to="/our-services/asset-integrity/asset-integrity-management">Explore Asset Integrity Services<ArrowRight/></SiteLink></Button></div></section>

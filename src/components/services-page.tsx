...
export function ServicesPage() {
  return <main>
    ...
    <section className="services-integrity reveal"><div className="services-integrity-image"><img src={serviceImages.integrity} alt="Industrial plant equipment supported by asset integrity services" loading="lazy" width="1400" height="1000"/></div><div className="services-integrity-copy"><ShieldCheck/><Heading eyebrow="Asset Integrity" title="Risk-Based Asset Integrity Services"/><p>TreeQ Power provides structured asset integrity services to help organizations understand equipment condition, identify risk, prioritize inspection activities and support lifecycle decisions.</p><p>Our approach can combine asset information, inspection history, failure mechanisms, condition assessment, criticality and operational considerations to establish practical inspection and integrity strategies.</p><Button variant="outline" asChild><SiteLink to="/our-services/asset-integrity">Explore Asset Integrity Services</SiteLink></Button></div></section>

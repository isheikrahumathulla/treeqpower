...
export function CompanyOverviewPage() {
  return <main>
    <section className="page-hero"><img src={companyOverviewImages.hero} alt="Power transformer installed within an electrical substation compound" width="1800" height="1200"/><div className="page-hero-wash"/><div className="zoho-shell page-hero-copy reveal"><p className="zoho-kicker">Company Overview</p><h1>Building Reliable Power, Engineering &amp; Asset Solutions</h1><p>Tree Q Power Electromechanical LLC is a UAE-based engineering, electromechanical and independent inspection services company, registered in Dubai, United Arab Emirates under Commercial Registration No. 829050.</p><div><Button size="lg" asChild><SiteLink to="/contact">Start an Enquiry<ArrowRight/></SiteLink></Button><Button size="lg" variant="outline" asChild><SiteLink to="/our-services">Explore Our Services</SiteLink></Button></div></div></section>
